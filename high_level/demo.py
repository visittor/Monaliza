...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        # self.radioButton.setGeometry(QtCore.QRect(10, 50, 91, 21))
        # self.radioButton.setObjectName(_fromUtf8("radioButton"))
        # self.dial = QtGui.QDial(self.tab)
        # self.dial.setGeometry(QtCore.QRect(200, 20, 50, 60))
        # self.dial.setMaximum(10)
        # self.dial.setObjectName(_fromUtf8("dial"))
        # self.spinBox = QtGui.QSpinBox(self.tab)
        # self.spinBox.setGeometry(QtCore.QRect(250, 40, 50, 20))
        # self.spinBox.setObjectName(_fromUtf8("spinBox"))
        # self.label = QtGui.QLabel(self.tab)
        # self.label.setGeometry(QtCore.QRect(200, 70, 46, 13))
    ...
    def retranslateUi(self, MainWindow):
        ...
        # self.radioButton.setText(_translate("MainWindow", "RadioButton1", None))
